...
The source design for the integration's icon and logo — the vlios.cz
shutter-slat motif with a Jablotron-yellow **JA-RS** wordmark.
...
same PNGs are copied into `custom_components/ja_rs485/brand/`, and Home
