"""Render the brand PNGs for the JA-RS485 integration.

Draws the same design as icon.svg with Pillow -- the vlios.cz shutter-slat
motif behind a Jablotron-yellow JA-RS wordmark with vlios.cz beneath -- and
writes the four files Home Assistant expects: a square icon and a wider logo,
each at 1x and 2x.
...
RED = (226, 0, 26, 255)
YELLOW = (247, 166, 0, 255)  # Jablotron yellow
...
def render_icon() -> Image.Image:
    """The square icon: slats, JA-RS, vlios.cz, trimmed to fill the square."""
    size = 512
    ...
    _text(draw, (256, 250), "JA-RS", _font(120), YELLOW, spacing=4)
...
def render_logo() -> Image.Image:
    """The wide logo: JA-RS with vlios.cz beneath, for the config dialog."""
    w, h = 720, 400
    ...
    _text(draw, (360, 200), "JA-RS", _font(150), YELLOW, spacing=5)
